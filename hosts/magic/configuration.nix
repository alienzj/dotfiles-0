...

{
  ...
  # Enable swap on luks
  boot.initrd.luks.devices."luks-ae0512f8-557d-4971-af4c-f394869893e1".device = "/dev/disk/by-uuid/ae0512f8-557d-4971-af4c-f394869893e1";
  boot.initrd.luks.devices."luks-ae0512f8-557d-4971-af4c-f394869893e1".keyFile = "/crypto_keyfile.bin";
